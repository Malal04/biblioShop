        ...
        <main class="main">
            ...
            <section class="section_livre py-5">
                <div class="container">
                    ...
                    <section class="mb-5">
                        <h2 class="mb-4">Nouveautés Livres</h2>
                        <div class="row">
                            @foreach ($nouveaux as $livre)
                    ...
                    <section class="mb-5">
                        <h2 class="mb-4"> Meilleures ventes Livres</h2>
                        <div class="row">
                            @foreach ($meilleuresVentes as $livre)
                            <div class="col-md-4 mb-4">
                                <div class="card h-100 shadow-sm">
                                    <img src="{{ asset('storage/' . $livre->image) }}" class="card-img-top" alt="{{ $livre->titre }}" style="height: 230px; object-fit: cover;">
                                    <div class="card-body d-flex flex-column">
                    ...
                    {{-- Section 3 : Les plus populaires --}}
                    <section>
                        <h2 class="mb-4">Les plus populaires Livres</h2>
                        <div class="row">
                            @foreach ($populaires as $livre)
                            <div class="col-md-4 mb-4">
                                <div class="card h-100 shadow-sm">
                                    <img src="{{ asset('storage/' . $livre->image) }}" class="card-img-top" alt="{{ $livre->titre }}" style="height: 230px; object-fit: cover;">
                                    <div class="card-body d-flex flex-column">
